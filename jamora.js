...
Jamora.hangulToRomaja = function(str) {
...
Jamora.toRomaja = function() {
	return this.hangulToRomaja.apply(this, arguments);
};

Jamora.toRomaji = Jamora.toRomaja;

Jamora.toHiragana = function(str) {
	return str;
};
...
if(typeof String.prototype.toRomaja == 'undefined') {
	String.prototype.toRomaja = function() {
		var args = Array.prototype.slice.call(arguments);
		args.unshift(this);
		return Jamora.toRomaja.apply(Jamora, args);
	};
}

if(typeof String.prototype.toRomaji == 'undefined') {
